  ...
  return (
    <section className="relative transition-all duration-500 lg:min-h-screen lg:flex lg:items-center bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-[#393c23] via-green-700 to-[#393c23] bg-cover bg-center">
      ...
      <div className="relative mx-auto max-w-screen-2xl px-4 py-16 sm:px-6 lg:px-8">
        <header>
          <h2 className={`text-3xl lg:text-7xl text-white uppercase`}>
            Our Range
          </h2>

          <p className={`mt-2 text-white text-xl`}>
            <span className="great-vibes-regular text-orange-200">TESS —</span>
            is a brilliant example of centuries-old tea traditions, complemented
            with innovative style and inspiring improvisation in creation of tea
            compositions
          </p>
        </header>
